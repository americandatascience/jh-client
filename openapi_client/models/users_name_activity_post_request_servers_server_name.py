...
class UsersNameActivityPostRequestServersServerName(BaseModel):
    """
    Activity for a single server. 
    """ # noqa: E501
    last_activity: datetime = Field(description="Timestamp of last-seen activity on this server. ")
    __properties: ClassVar[List[str]] = ["last_activity"]
