...
class Oauth2TokenPost200Response(BaseModel):
    """
    Oauth2TokenPost200Response
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="The new API token for the user")
    token_type: Optional[StrictStr] = Field(default=None, description="Will always be 'Bearer'")
